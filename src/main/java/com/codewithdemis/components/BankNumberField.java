...
public class BankNumberField extends JTextField {
    ...
    public BankNumberField(String placeholder) {
        this(placeholder, "primary");
    }

    public BankNumberField(String placeholder, String variant) {
        super();
    ...
    public void setText(String text) {
        if (text.matches("\\d*")) { // Ensure only numbers
            super.setText(text);
        } else {
            super.setText(getText().replaceAll("[^\\d]", "")); // Strip non-numeric input
        }
    }
